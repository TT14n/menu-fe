...
import type { RecipeType, Ingredient } from '../types';
...
export function AddRecipeModal({ isOpen, onClose, onSubmit, isMobile = false }: AddRecipeModalProps) {
        ...
        <form onSubmit={handleSubmit} style={{ padding: isMobile ? '20px' : '24px' }}>
              ...
              {(['快手菜', '功夫菜'] as RecipeType[]).map(recipeType => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: '8px',
                    background: type === recipeType ? '#722ed1' : '#fff',
                ...
                {selectedIngredients.map((ing, index) => (
                  <div
                    ...
                    style={{
                      ...
                      justifyContent: 'space-between',
                      padding: '12px 16px',
                      borderBottom: index < selectedIngredients.length - 1 ? '1px solid #efdbff' : 'none',
                      transition: 'background 0.2s'
                    }}
                    onMouseEnter={(e) => e.currentTarget.style.background = '#f9f0ff'}
                    onMouseLeave={(e) => e.currentTarget.style.background = 'transparent'}
          ...
          <div style={{ marginBottom: '24px' }}>
            ...
            <textarea
              ...
              onFocus={(e) => (e.target as HTMLTextAreaElement).style.borderColor = '#722ed1'}
